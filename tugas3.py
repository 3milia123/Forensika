...
logo_path = 'logotelu.png'
new_metadata = {'/Title': 'Pengembangan Sistem Informasi Layanan Pusat Karir dengan Memanfaatkan Peta Digital Mapbox', '/Author': 'Emil', '/Subject': 'Forensika'}
